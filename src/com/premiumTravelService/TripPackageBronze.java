...
public class TripPackageBronze extends TripPackageType{
    ...
    public TripPackageBronze(String packageName, Double price, String transportType, String transportType1) {
        super();
