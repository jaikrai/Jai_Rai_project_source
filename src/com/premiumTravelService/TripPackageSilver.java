...
public class TripPackageSilver extends TripPackageType{
    ...
    public TripPackageSilver(String packageName, Double price, String transportType, String transportType1) {
        super();
